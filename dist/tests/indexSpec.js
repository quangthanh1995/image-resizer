...
describe('Test endpoint', function () {
    it('should get API to resize image successfully.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/images?filename=fjord&width=400&height=400')];
                case 1:
                    response = _a.sent();
    ...
    it('should not get API to image with wrong query.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/images?filename=fjord&width=400&height')];
                case 1:
                    response = _a.sent();
    ...
    it('should not get API to resize image when the image does not exist.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/images?filename=fjord123&width=400&height=400')];
                case 1:
                    response = _a.sent();
